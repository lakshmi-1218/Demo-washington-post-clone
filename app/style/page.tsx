...
import Latest from "@/components/latest-section";
import { TeslaAd } from "@/components/adds-section";
        ...
        <div className="bg-white text-black">
            ...
            <div className="mb-6 border-b">
                    <div className="flex items-center gap-3 mb-2">
                        <h1 className="text-5xl font-serif font-bold tracking-tight">Styles</h1>
        ...
        >
            ...
            <div>
                ...
                <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-14">
                    ...
                    {/* SIDEBAR */}
                    <aside className="space-y-8 sm:space-y-10 pt-5">
