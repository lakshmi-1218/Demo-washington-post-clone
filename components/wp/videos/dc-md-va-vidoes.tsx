...
export default function DCMdVaVideosSection() {
  const scrollRef = useRef<HTMLDivElement>(null);
  const videos = [
    { id: 1, slug: "ai-world-economist", title: "Washington DC City Council Updates", thumbnail: "https://picsum.photos/id/1051/400/225", duration: "2:48", date: "Feb 12, 2026" },
    { id: 2, slug: "capitol-attack-explained", title: "Maryland Weather Alert Explained", thumbnail: "https://picsum.photos/id/1052/400/225", duration: "3:11", date: "Feb 11, 2026" },
    { id: 3, slug: "media-viral-videos", title: "Virginia Election Campaign Trail", thumbnail: "https://picsum.photos/id/1053/400/225", duration: "4:04", date: "Feb 10, 2026" },
    { id: 4, slug: "ai-world-economist", title: "Metro Rail Expansion Project", thumbnail: "https://picsum.photos/id/1054/400/225", duration: "2:35", date: "Feb 9, 2026" },
    { id: 5, slug: "capitol-attack-explained", title: "DC Schools Policy Changes", thumbnail: "https://picsum.photos/id/1055/400/225", duration: "3:22", date: "Feb 8, 2026" },
    { id: 6, slug: "media-viral-videos", title: "Maryland Traffic & Transit Update", thumbnail: "https://picsum.photos/id/1056/400/225", duration: "2:57", date: "Feb 7, 2026" },
  ];
  ...
  return (
    <section className="w-full bg-white mt-4 sm:mt-6 border-b border-gray-200 px-2 sm:px-4 lg:px-0">
      <div className="flex items-center justify-between mb-3"><h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900">DC · MD · VA Videos</h2></div>
