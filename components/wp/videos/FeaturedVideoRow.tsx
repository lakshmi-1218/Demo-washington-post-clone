...
const videos: Video[] = [
  {
    id: "v1",
    thumbnail: "https://picsum.photos/id/1020/300/533",
    title: "AI-powered drones map city traffic in real-time",
    duration: "1:12",
    videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",
  },
  {
    id: "v2",
    thumbnail: "https://picsum.photos/id/1024/300/533",
    title: "Community garden transforms vacant lot into urban oasis",
    duration: "0:58",
    videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4",
  },
  {
    id: "v3",
    thumbnail: "https://picsum.photos/id/1025/300/533",
  ...
  {
    id: "v4",
    thumbnail: "https://picsum.photos/id/1027/300/533",
    title: "Local bakery experiments with 3D-printed pastries",
    duration: "0:49",
    videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4",
  },
  {
    id: "v5",
    thumbnail: "https://picsum.photos/id/1031/300/533",
    title: "Wildlife photographer captures rare Arctic fox in action",
    duration: "1:18",
...
export default function FeaturedVideos() {
  ...
  return (
    <section className="max-w-[1200px] mx-auto relative mt-2 border-b-2 border-black px-1 lg:p-0">
      {/* Header */}
